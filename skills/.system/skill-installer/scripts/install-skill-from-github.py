#!/usr/bin/env python3
"""Install a skill from a GitHub repo path into $KIMI_CODE_HOME/skills."""
...
def _kimi_home() -> str:
    return os.environ.get("KIMI_CODE_HOME", os.path.expanduser("~/.kimi-code"))


def _tmp_root() -> str:
    base = os.path.join(tempfile.gettempdir(), "kimi")
    os.makedirs(base, exist_ok=True)
    return base


def _request(url: str) -> bytes:
    return github_request(url, "kimi-skill-install")
...
def _default_dest() -> str:
    return os.path.join(_kimi_home(), "skills")
