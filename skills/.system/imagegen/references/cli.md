...
Set a stable path to the skill CLI (default `KIMI_CODE_HOME` is `~/.kimi-code`):

```
export KIMI_CODE_HOME="${KIMI_CODE_HOME:-$HOME/.kimi-code}"
export IMAGE_GEN="$KIMI_CODE_HOME/skills/.system/imagegen/scripts/image_gen.py"
```
...
- Built-in-first transparent image workflow: `SKILL.md` and `$KIMI_CODE_HOME/skills/.system/imagegen/scripts/remove_chroma_key.py`
